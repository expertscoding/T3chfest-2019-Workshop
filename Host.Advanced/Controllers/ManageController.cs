...
using Host.Advanced.Models.ManageViewModels;
...
namespace Host.Advanced.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        private readonly IU2FManagerService u2FManagerService;
        ...
        public ManageController(
          ...
          IU2FManagerService u2FManagerService)
        {
            _userManager = userManager;
            _signInManager = signInManager;
            _logger = logger;
            _urlEncoder = urlEncoder;
            this.u2FManagerService = u2FManagerService;
        }
        ...
        public async Task<IActionResult> TwoFactorAuthentication()
        {
            ...
            {
                Devices = user.DeviceRegistrations?.Select(d => new DeviceModel { Id = d.Id, DeviceName = d.DeviceName, Counter = d.Counter, CreatedOn = d.CreatedOn, KeyHandle = Convert.ToBase64String(d.KeyHandle) }).ToList() ?? new List<DeviceModel>(),
        ...
        public async Task<IActionResult> RemoveDevice(int deviceId)
        {
            ...
            await u2FManagerService.RemoveDeviceAsync(user.UserName, deviceId);
        ...
        private string GenerateQrCodeUri(string email, string unformattedKey)
        {
            return string.Format(
                ...
                _urlEncoder.Encode("Advance SSO Local"),
